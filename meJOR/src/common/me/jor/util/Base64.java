...
public final class Base64 {
    ...
    static {
        ...
        if(fDebug){
        	System.out.println(new String(lookUpBase64Alphabet));
        }
    }
     ...
     */
    public static String encode(byte[] binaryData, char[] lookUpBase64Alphabet){
        if (binaryData == null) {
            return null;
        }
    ...
    public static String encode(byte[] binaryData) {
    	return encode(binaryData,lookUpBase64Alphabet);
    }
