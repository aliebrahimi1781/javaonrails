...
public class FileUtil {
	public static final ReentrantReadWriteLock.ReadLock SVN_READ_LOCK=LockCache.getReadLock("common_svn_lock");
	public static final ReentrantReadWriteLock.WriteLock SVN_WRITE_LOCK=LockCache.getWriteLock("common_svn_lock");
	/**
