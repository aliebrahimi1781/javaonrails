...
public class XMLTransformer {
	...
	public XMLTransformer(){
		this(CommonConstant.DEFAULT_CHARSET);
	}
	/**
	...
	public XMLTransformer transform(Node xmlNode, File xslt, File dest) throws TransformerException, IOException{
		Source xmlSource=new StreamSource(new StringReader(xmlNode.asXML()));
		Source xsltSource=new StreamSource(xslt);
	 ...
	 * @throws IOException 
	 * */
	public XMLTransformer transform(org.w3c.dom.Node xmlNode, File xslt, File dest) throws TransformerException, IOException{
	 ...
	 * @throws IOException 
	 * */
	public XMLTransformer transform(org.w3c.dom.Node xmlNode, String xsltPath, String destOutputPath) throws TransformerException, IOException{
		return transform(xmlNode,new File(xsltPath), new File(destOutputPath));
	}
	/**
	 * @param xmlNode:   要转换的xml节点对象，可表示一个dom4j Document对象,或一个Element对象
	 ...
	 * @throws TransformerException
	 * */
	public XMLTransformer transform(org.w3c.dom.Node xmlNode, Reader xslt, Writer dest) throws TransformerException{
		Source xmlSource=new DOMSource(xmlNode);
		Source xsltSource=new StreamSource(xslt);
		Result result=new StreamResult(dest);
		TransformerFactory factory=TransformerFactory.newInstance();
	 ...
	 * @throws TransformerException
	 * */
	public XMLTransformer transform(org.w3c.dom.Node xmlNode, InputStream xslt, OutputStream dest) throws TransformerException{
		Source xmlSource=new DOMSource(xmlNode);
		Source xsltSource=new StreamSource(xslt);
		Result result=new StreamResult(dest);
		TransformerFactory factory=TransformerFactory.newInstance();
